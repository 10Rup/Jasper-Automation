...
def imgToCode(band: str,fields: dict,config: dict,imgPath: str, apiKey: str):
    ...
    prompt = f"""
        ...
        C. Now analyze the image and generate JRXML for <{band}>.
            ...
            16. If Hindi text is present in the report image then try to extract it as accurately as possible.
        --------------------------------------------------
    ...
    code = clean_jrxml_response(code)
    return code
